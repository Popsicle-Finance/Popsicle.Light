<template>
  <div class="notification-item">
    ...
    <img
      src="@/assets/images/notifications/close-btn.svg"
      alt=""
      class="hide-notify"
    ...
    <img
      src="@/assets/images/notifications/notification-main.png"
      alt=""
      class="main-img"
    />
    ...
    <div class="content-wrap">
      ...
      <div class="timestamp" v-if="!notification.isError">
        <img
          src="@/assets/images/notifications/clock.svg"
          alt=""
          class="clock-icon"
        />
        <p>{{ parsedTime }}</p>
